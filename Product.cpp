...
Product::Product(const char *name, unsigned int price, unsigned int unitsAvailable, unsigned int unitsSold) : price(price), unitsAvailable(unitsAvailable), unitsSold(unitsSold)
{
